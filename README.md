...
| GraalVM native image | a cold process answers a search in **tens of milliseconds**, measured and bounded on every push, from a 42 MB static binary | needs gRPC, Netty and protobuf native configuration you write and maintain |
...
process start, client construction and one round trip rather than a collection being built. Nothing is required of you:
